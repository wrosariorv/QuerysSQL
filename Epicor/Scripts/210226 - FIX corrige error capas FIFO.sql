...
DECLARE
	  @Company nvarchar(1000) = '<ALL>'  -- si necesito Sontec preguntar a Rafael
	, @PartNum nvarchar(1000) = 'X50ANDTV'    --<------------ you must enter the part number that you want to run this for
